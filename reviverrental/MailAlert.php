...
class MailAlertRental extends ObjectModel
{
    public $id_customer;
    ...
    public static function getMailAlerts($id_customer, $id_lang, Shop $shop = null)
    {
        ...
        $customer = new Customer($id_customer);
        $products = MailAlert_rental::getProducts($customer, $id_lang);
    ...
    public static function sendCustomerAlert($id_product, $id_product_attribute)
    {
        ...
        foreach ($customers as $customer) {
            ...
            if (file_exists(dirname(__FILE__).'/mails/'.$iso.'/customer_qty.txt') &&
                ...
                Mail::Send((int)Configuration::get('PS_LANG_DEFAULT'), 'customer_qty', Mail::l('Product available', $id_lang), $templateVars, $customer_email, null, Configuration::get('PS_SHOP_EMAIL'), Configuration::get('PS_SHOP_NAME'), null, null, dirname(__FILE__).'/mails/');
            }
            ...
            self::deleteAlert((int)$customer_id, $customer_email, (int)$id_product, (int)$id_product_attribute);
        }
    }
